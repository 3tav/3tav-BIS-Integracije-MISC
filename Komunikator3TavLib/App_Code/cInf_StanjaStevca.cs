...
namespace Komunikator3TavLib
{
    ...
    public class dcMenjavaDobZahteva
    {
        ...
        /* nova polja - MT */
        [DataMember]
        public string GsrnMT { get; set; }
        [DataMember]
        public string VrstaMenjave { get; set; }        
        [DataMember]
        public string ImePogodbe { get; set; }
        [DataMember]
        public byte[] Pogodba { get; set; }
        [DataMember]
        public int IdZahtevaBIS { get; set; }
    }
    ...
    public class dcNovaPoD
    {
        ...
        public string VrstaMenjave { get; set; }
        [DataMember]
        public string VrstaMenjavePriloga { get; set; }
        [DataMember]
        public string KontaktnaOseba { get; set; }
        [DataMember]
        public Boolean SpremembaProdajalca { get; set; }
        [DataMember]
        public Boolean SpremembaProdajalcaNaslov { get; set; }
        [DataMember]
        public int IdZahtevaBIS { get; set; }
    }
